    ...
    post {
        ...
        success {
            emailext(
                ...
                body: "The Jenkins Pipeline has completed successfully. Check the attached log for details.",
                attachLog: true
            )
        }
        failure {
            emailext(
                ...
                body: "The Jenkins Pipeline has failed. Check the attached log for details.",
                attachLog: true
            )
        }
    }
